  ...
  return (
    <div className='home-tab'>
      ...
      <div className='home-tab-text'>
       ...
       <p style={{fontSize:14,lineHeight:1.3,color:'white',lineHeight:2,}}>HQ Construction has successfully established itself in the private commercial construction space by providing intelligent design and quality construction services in the childcare, aged care, social, religious and education sectors. With a fresh approach to the use of different construction methods and products, we can provide alternative solutions to commercial developments.</p>
      </div>
    </div>
  )
}
