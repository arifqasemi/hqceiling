  ...
  return (
    <div className='service-section'>
     <div className='service-section-wrapper'>
        <h3 style={{color:'#ffb703',textTransform:'uppercase'}}>Our services  </h3>
        <h2 style={{fontSize:56,fontWeight:800}}>Our construction services</h2>
        <p style={{fontSize:16,marginTop:20,color:'#667282'}}>We specialize in a wide range of construction services, including residential, commercial, and industrial projects.</p>
          ...
          <div className='service-content'>
            ...
            <p style={{color:'white'}}>Our post-construction services gives you peace of mind knowing that we are still here for you even after.</p>
             <div className='service-cta' style={{display:'flex',alignItems:'center',cursor:'pointer'}}>
               ...
               <FontAwesomeIcon icon={faArrowRight} color='#ffb703' style={{marginTop:12}}/>
             </div>
          </div>
        </div>
        <div className='service'>
